...
export interface EventMethods {
	...
	// onFieldChange?: (this: Battle, target: Pokemon, source: Pokemon, sourceEffect: Effect) => void;
	...
	onTerrain?: (this: Battle, target: Pokemon, source: null, effect: Condition) => void;
	onField?: (this: Battle, target: Pokemon, source: null, effect: Condition) => void;
...
export class Condition extends BasicEffect implements
	...
	declare readonly effectType: 'Condition' | 'Weather' | 'Status' | 'Terrain' | 'Field';
	...
	constructor(data: AnyObject) {
		super(data);
		this.effectType = (['Weather', 'Status', 'Terrain', 'Field'].includes(data.effectType) ? data.effectType : 'Condition');
