...
export class Pokemon {
	...
	*/
	...
	isGrounded(negateImmunity = false) {
		...
		if (this.hasAbility('lunaridol') && !this.battle.suppressingAbility(this)) return null;
		if (this.hasAbility('solaridol') && !this.battle.suppressingAbility(this)) return null;
