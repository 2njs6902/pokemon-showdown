...
export const Avatars = new class {
	...
	canUse(userid: ID, avatar: string): AvatarID | null {
		...
		// Official avatars continue using their normal sanitized ID.
		if (OFFICIAL_AVATARS.has(normalizedAvatar)) {
			return normalizedAvatar as AvatarID;
		}

		// Find the actual local filename whose normalized version matches.
		const localAvatar = getLocalTrainers().find(filename =>
			filename
				.toLowerCase()
				.replace(/[^a-z0-9-.#]+/g, '') === normalizedAvatar
		);

		if (localAvatar) {
			return localAvatar as AvatarID;
		}

		const customs = customAvatars[userid]?.allowed;
		if (!customs) return null;

		if (customs.includes(normalizedAvatar as AvatarID)) {
			return normalizedAvatar as AvatarID;
		}
		if (customs.includes(('#' + normalizedAvatar) as AvatarID)) {
			return ('#' + normalizedAvatar) as AvatarID;
		...
		if (
			...
			customs.includes(normalizedAvatar.slice(1) as AvatarID)
		) {
			return normalizedAvatar.slice(1) as AvatarID;
		}
...
const OFFICIAL_AVATARS = new Set([
	...
	'bugsy - GS', 'bugsy - HGSS',
	'burgh - BW',
	'burglar - RB', 'burglar - Y', 'burglar - GS', 'burglar - FRLG', 'burglar - HGSS',
	// 'byron',
	...
	'ethan - C', 'ethan - GS', 'ethan (pokeathlon) - HGSS', 'ethann - HGSS',
	// 'eusine-gen2', 'eusine',
	// 'expertf-gen3',
	// 'expert-gen3',
	// 'falkner-gen2',
	...
	'team aqua beta - RS', 'team aqua grunt f - RS', 'team aqua grunt m - RS',
...
const OFFICIAL_AVATARS_BELIOT419 = new Set([
	...
	'molayne - SM', 
	'nanu - SM',
	// 'officeworker', 'olivia', 'plumeria', 'pokemonbreeder-gen7',
...
const OFFICIAL_AVATARS_GNOMOWLADNY = new Set([
	// 'az', 'brawly-gen6', 'bryony', 
	'drasna - XY', 
	// 'evelyn', 'furisodegirl-black', 'furisodegirl-pink', 
	'guzma - SM',
...
const OFFICIAL_AVATARS_BRUMIRAGE = new Set([
	...
	// 'bede-leader', 
	'brendan (contest) - ORAS',
	'burnet - dream radar',
	//  'calaba', 'calem', 'chase', 
	'cogita - LA', 
	'cynthia - SM', 'cynthia (1) - masters', 
	'diantha - XY', 
	// 'doctor-gen8', 'elaine', 'gloria', 'gordie', 'hilda-masters2', 'hop',
...
const OFFICIAL_AVATARS_KYLEDOVE = new Set([
	// 'acetrainerf-gen6', 'acetrainerf-gen6xy', 'acetrainer-gen6', 'acetrainer-gen6xy', 
	'aqua grunt m - ORAS', 'aqua grunt f - ORAS', 'aqua grunt - RS', 'aqua grunt f - RS',
	'aqua suit - ORAS', 
	...
	'celio - FRLG', 
	// 'charon', 'clover', 'colza', 'concordia', 'cyllene', 
	'dawn (contest) - DP', 
	// 'elm', 'erika-lgpe', 'fennel', 'gaeric',
	...
	// 'anthe', 'anvin', 
	'burglar - LGPE', 
	// 'channeler-lgpe', 'choy', 'dagero', 'gentleman-lgpe', 'grace',
	...
	// 'acerola-masters', 'bea-masters', 'blue-masters', 
	'brendan (1) - masters',
	// 'brock-masters', 
	'burgh - masters', 
	// 'caitlin-masters',
	'cynthia (1) - anime', 'cynthia (2) - anime',  'cynthia (2) - masters', 'cynthia (3) - masters', 'cynthia (4) - masters', 'cynthia (5) - masters',
	'cyrus - masters', 
	'dawn (1) - masters', 'dawn (2) - masters', 
	// 'diantha-masters', 
	'elesa (1) - masters', 'elesa (2) - masters', 'elesa (3) - masters',
	// 'emmet-masters',
	// 'erika-masters', 'erika-masters2', 
	'ethan - masters', 
	// 'giovanni-masters', 'gloria-masters', 'grimsley-masters',
	'guzma - masters',
	...
	// 'may-masters3', 'misty-masters', 
	'morty (1) - masters', 'morty (2) - masters', 'morty (3) - masters', 
	// 'n-masters', 'n-masters2', 'nessa-masters',
	...
	// 'akari-isekai', 'allister-masters', 'arven-s', 'brassius', 'clavell-s', 'florian-s',
	...
	// 'beauty-gen9', 'bede-masters', 'calem-masters', 'clerk-unite', 
	'dawn (3) - masters', 
	// 'dendra', 'diantha-masters2',
	...
	'alec - anime', 
	'bodybuilder m - SV', 'bodybuilder f - SV',
	// 'carmine-festival', 'carmine', 'diamondclanmember', 'dragontamer-gen9', 
	// 'kieran-festival', 'kieran',
	...
	'brendan (2) - RS', 
	// 'briar', 'cabbie-gen9', 'caretaker', 'clair-masters', 'clive-v', 'cook-gen9', 'courier', 'crispin', 'cyrano',
	// 'delinquent-gen9', 'delinquentf-gen9', 'delinquentf2-gen9', 
	'drayton - SV', 
	// 'flaregrunt', 'flaregruntf', 'florian-festival',
	...
	'aarune - ORAS', 
	// 'adaman-masters', 'allister-unmasked', 'anabel', 
	// 'archie-usum',
	// 'arlo', 'barry-masters', 'blanche-casual', 'blanche', 'brandon', 'candela-casual', 'candela', 
	'candice - masters', 
	// 'christoph',
	...
	// 'baoba', 'bill', 'daisy', 'harmony', 'paxton', 'trace', 'az-lza', 
	'brendan (2) - masters', 
	'bugsy - masters',
	'elio - masters', 
	// 'erika-masters3', 'iono-masters', 'iono-masters2',
	// 'lance-masters2', 'marley-masters', 'may-masters4', 
	// 'selene-masters2', 'shauntal-masters',
...
const OFFICIAL_AVATARS_GRAPO = new Set([
	// 'glacia', 'peonia', 
	'phoebe - masters', 
	// 'rosa-masters3', 'scottie-masters', 'skyla-masters2', 'volo-ginkgo',
]);
...
const LOCAL_AVATARS_ZUMI = new Set([
	'aero - rejuvenation',
	'aevia - rejuvenation',
	'aevis - rejuvenation',
	'alain - rejuvenation',
	...
	'ariana - rejuvenation',
	'axel - rejuvenation',
	'goomink - rejuvenation',
	'keta (2) - rejuvenation',
	'melia - rejuvenation',
]);

const LOCAL_AVATARS_MIGUEL_HORO = new Set([
	'luxus - fairytail',
]);
...
export const commands: Chat.ChatCommands = {
	...
	avatar(target, room, user) {
		...
		if (!silent || this.broadcasting) {
			...
			if (LOCAL_AVATARS_ZUMI.has(avatar)) {
				this.sendReply(`|raw|(${this.tr`Artist: `}<a href="https://bsky.app/profile/honnojis.art">Zumi</a>)`);
			}
			if (LOCAL_AVATARS_MIGUEL_HORO.has(avatar)) {
				this.sendReply(`|raw|(${this.tr`Artist: `}<a href="https://x.com/Miguel_Horo">Miguel Horo</a>)`);
			}
		}
	},
	avatarhelp: [
